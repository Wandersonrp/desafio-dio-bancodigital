...
public class TesteExtratoBancario {
	...
	public static void main(String[] args) {
		...
		String resultadoPesquisa = ccpf.obterExtrato(cliente, ccpf, banco);
		...
		resultadoPesquisa = ccpj.obterExtrato(clientePJ, ccpj, banco);
		System.out.println(resultadoPesquisa);
		...
		resultadoPesquisa = contaPoupanca.obterExtrato(clientePoupanca, contaPoupanca, banco);
		System.out.println(resultadoPesquisa);
	}
}
